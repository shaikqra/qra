  ...
  return (
    <form onSubmit={submit} className="mt-5">
      <input
        ...
        className="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#3f5bd9]"
      />
      <button
        type="submit"
